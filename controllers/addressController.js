...
exports.getAddress = async (req, res) => {
  try {
    ...
    const radius = parseFloat(req.query.radius) > 50 ? 10000 : parseFloat(req.query.radius)  // Convert km to meters, default to 100km if > 50km

    console.log("Received query params:", radius, userLat, userLong);
